...
As instruções completas de execução serão adicionadas conforme o desenvolvimento do projeto.
...
Esta seção será completada durante o desenvolvimento para explicar o conceito de arquitetura cliente-servidor e sua relação com a simulação de carregamento das vagas utilizada no projeto.

## Organização do projeto

O desenvolvimento será organizado utilizando um quadro Kanban com as seguintes colunas:
